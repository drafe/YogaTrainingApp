...
)
{
    ...
    fun setupPoseLandmarker() {
        ...
        val modelName =
            when (currentModel) {
                MODEL_POSE_LANDMARKER_FULL -> "models/pose_landmarker_full.task"
                MODEL_POSE_LANDMARKER_LITE -> "models/pose_landmarker_lite.task"
                MODEL_POSE_LANDMARKER_HEAVY -> "models/pose_landmarker_heavy.task"
                else -> "models/pose_landmarker_full.task"
            }
